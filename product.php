                    ...
                    <div class="card" style="margin-bottom: 2rem;">
                        ...
                        <div class="related-posts">
                            <?php foreach ($relatedContent as $content): ?>
                                <a href="/post/<?php echo htmlspecialchars($content['slug']); ?>" class="related-post-item">
                        ...
                        <?php if (!empty($categories)): ?>
                            <div>
                                ...
                                <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                                    <?php foreach ($categories as $cat): ?>
                                        <a href="/category/<?php echo htmlspecialchars($cat['slug']); ?>" class="badge badge-primary" style="text-decoration: none;">
                    ...
                    <?php foreach ($relatedProducts as $related): ?>
                        <article class="post-card product-card">
                            <?php if ($related['image_url']): ?>
                                <a href="/product/<?php echo htmlspecialchars($related['slug']); ?>" class="post-image">
                            ...
                            <div class="post-body">
                                ...
                                <h3 class="post-title">
                                    <a href="/product/<?php echo htmlspecialchars($related['slug']); ?>">
