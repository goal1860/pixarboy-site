        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <p>Your trusted source for honest tech product reviews and expert buying guides. We test every product ourselves to help you make informed purchasing decisions on gadgets, electronics, and the latest technology.</p>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> <?php echo SITE_NAME; ?>. All rights reserved. Made with ❤️</p>
            </div>
        </div>
    </footer>
